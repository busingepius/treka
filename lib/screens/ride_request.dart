...
import 'package:treka/widgets/custom_btn.dart';
import 'package:treka/widgets/custom_text.dart';
import 'package:treka/widgets/stars.dart';
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                if (appState.riderModel.photo != null)
                  Container(
                    ...
                    child: CircleAvatar(
                      radius: 45,
                      child: Icon(Icons.account_circle_outlined), /*ADDED THIS*/
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                CustomText(text: appState.riderModel?.name ?? "Pio"),
              ],
            ),
            SizedBox(height: 10),
            stars(
              ...
              subtitle: FlatButton.icon(
                  onPressed: () async {
                    ...
                    appState.addLocationMarker(
                        ...
                        appState.rideRequestModel?.destination ?? "Pio Lev",
                        "Destination Location");
                    showModalBottomSheet(
                        context: context,
                        builder: (BuildContext /*WAS* bc*/ context) {
                          return Container(
                            height: 400,
                            child: GoogleMap(
                  ...
                  label: CustomText(
                    text: appState.rideRequestModel?.destination ?? "Pio Dec",
                    weight: FontWeight.bold,
                  )),
            ),
            Divider(),
                  ...
                  onTap: () async {
                    if (appState.requestModelFirebase.status != "pending") {
                      ...
                      appState.acceptRequest(
                          ...
                          driverId: userProvider.userModel.value.id);
